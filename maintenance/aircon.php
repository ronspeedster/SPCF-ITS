		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a style='color: #5D4037; display: none;' class='btn btn-sm btn-warning' href="report_fixture.php?fixture_id=<?php echo $newFixtures['id']?>" target='_blank'><i class="fas fa-bug"></i> Report</a>
				</td>
			</tr>
			<?php } ?>
		</tbody>
