...
<div class="container-fluid">
	...
	<?php
		...
		$building_result = $mysqli->query("SELECT * FROM building b JOIN designation d ON d.building_id = b.building_id WHERE d.account_id = '$account_id'") or die ($mysqli->error);
