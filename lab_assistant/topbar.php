<!-- Topbar -->
 <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top" style="background-color: #424242 !important;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Alerts -->
            <li  style="visibility: hidden;" class="nav-item dropdown no-arrow mx-1">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-white-600 medium"><?php echo $_SESSION['account_id'].' | '.ucfirst($_SESSION['username']); ?></span>
                <i class="fas fa-user-circle"></i>
                <img style="display: none;" class="img-profile rounded-circle" src="">
              </a>
