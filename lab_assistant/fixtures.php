...
<?php
	...
	<div class="row justify-content-center">
		<form action="process_fixture.php" method="POST" style="display: none;">
		...
		<table class="table" id="dataTable" width="100%" cellspacing="0">
			...
			<tbody>
				<?php $getFixtures = mysqli_query($mysqli, "SELECT fe.id, fe.date_added, fe.serial_no, fe.type, fe.batch_code, fe.building_id, fe.lab_id, fe.remarks, bg.building_id, bg.building_name, ly.lab_id, ly.lab_name, d.account_id
					FROM fixture fe
					JOIN building bg
					...
					JOIN designation d 
					ON d.building_id = bg.building_id
			...
			?>
				<tr>
					...
					<td>
						...
						<button class="btn btn-danger btn-secondary dropdown-toggle btn-sm" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: none;">
