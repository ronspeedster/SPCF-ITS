	...
	if(!isset($_GET['PcId'])){
		...
		<thead>
			<tr>
				...
				B. Amount is in Peso Currency.<br>
				C. If item is not avaialable, type "N/A", amount "0" and pick any date.</td>
		...
		<!-- Start Monitor -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="monitor-brand" value="<?php if($isMonitor){echo $newMonitor['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="monitor-amount" value="<?php if($isMonitor){echo $newMonitor['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="monitor-remarks" value="<?php if($isMonitor){echo $newMonitor['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End MONITOR -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="keyboard-brand" value="<?php if($newKeyboard){echo $newKeyboard['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="keyboard-amount" value="<?php if($newKeyboard){echo $newKeyboard['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="keyboard-remarks" value="<?php if($newKeyboard){echo $newKeyboard['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Keyboard -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="mouse-brand" value="<?php if($isMouse){echo $newMouse['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="mouse-amount" value="<?php if($isMouse){echo $newMouse['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="mouse-remarks" value="<?php if($isMouse){echo $newMouse['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Mouse -->
			...
			<tr>
				...
				<td><textarea class="form-control" name="AVR-description" style="min-height: 40px; height: 40px;"><?php if($isAVR){echo $newAVR['peripheral_description'];}else{/*Do nothing*/}?></textarea></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="AVR-amount" value="<?php if($isAVR){echo $newAVR['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="AVR-remarks" value="<?php if($isAVR){echo $newAVR['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End AVR -->
			...
			<tr>
				...
				<td><textarea class="form-control" name="headset-description" style="min-height: 40px; height: 40px;"><?php if($isHeadset){echo $newHeadset['peripheral_description'];}else{/*Do nothing*/}?></textarea></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="headset-amount" value="<?php if($isHeadset){echo $newHeadset['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="headset-remarks" value="<?php if($isHeadset){echo $newHeadset['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Headset -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="cpu-brand" value="<?php if($isCPU){echo $newCPU['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="cpu-amount" value="<?php if($isCPU){echo $newCPU['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="cpu-remarks" value="<?php if($isCPU){echo $newCPU['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Processor -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="motherboard-brand" value="<?php if($isMotherboard){echo $newMotherboard['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="motherboard-amount" value="<?php if($isMotherboard){echo $newMotherboard['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="motherboard-remarks" value="<?php if($isMotherboard){echo $newMotherboard['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Motherboard -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="gpu-brand" value="<?php if($isGPU){echo $newGPU['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="gpu-amount" value="<?php if($isGPU){echo $newGPU['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="gpu-remarks" value="<?php if($isGPU){echo $newGPU['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End Motherboard -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="ram-brand" value="<?php if($isRAM){echo $newRAM['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="ram-amount" value="<?php if($isRAM){echo $newRAM['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="ram-remarks" value="<?php if($isRAM){echo $newRAM['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End RAM -->
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="hdd-brand" value="<?php if($isHDD){echo $newHDD['peripheral_brand'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="number" min="0" name="hdd-amount" value="<?php if($isHDD){echo $newHDD['peripheral_amount'];}else{/*Do nothing*/}?>"></td>
 				...
 				<td><input class="form-control" type="text" name="hdd-remarks" value="<?php if($isHDD){echo $newHDD['remarks'];}else{/*Do nothing*/}?>"></td>
 				<td>
 				</td>
			</tr>
			<!-- End RAM -->
